...
{
	public $menuGroupId = null;

	public function __construct()
	{
        parent::__construct();

        $this->menuGroupId = $this->getRequest()->getParam('groupid') ? $this->getRequest()->getParam('groupid') : 0;
	...
	{
		$collections = Mage::getModel('jmmegamenu/jmmegamenu')->getCollection()->addFieldToFilter("menugroup", array('eq' => $this->menuGroupId))->setOrder("parent", "DESC")->setOrder("ordering", "ASC");

<?php
   class Wavethemes_Jmbasetheme_Block_Adminhtml_system_config_form_colorpicker extends Mage_Adminhtml_Block_System_Config_Form_Field
   {
         protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
         {
            ...
            $output .= '<span  id="icp_'.$element->getHtmlId().'" class="mColorPickerTrigger" style="cursor:pointer;"><img align="absmiddle" style="border:0;margin:0 0 0 3px" src="'.$this->getJsUrl('joomlart/lib/mColorPicker/color.png').'"></span>';
